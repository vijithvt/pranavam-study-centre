            ...
            <div className="relative w-full md:w-2/3">
              ...
              <div className="flex md:items-start items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Today, Pranavam Study Centre stands as a symbol of hope and excellence in Vilappilsala—committed to helping every learner thrive. Over the years, we've become part of countless student journeys—from those who overcame their fear of science and math, to those who found their voice in English communication, and many who simply rediscovered the joy of learning.
                  </p>
                </div>
              </div>
            </div>
